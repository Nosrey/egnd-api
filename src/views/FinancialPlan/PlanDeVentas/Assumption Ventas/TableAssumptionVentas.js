                ...
                >
                  ...
                  <FormItem className="col-start-2 col-end-6 row-start-2 mb-0">
                    ...
                    {errors[prod.id] && errors[prod.id].name && (
                      <p className="danger">{errors[prod.id].name}</p>
                    )}
                  </FormItem>
                ...
                >
                  <div className="flex justify-between gap-x-2">
                    ...
                    <Button
                      ...
                      onClick={() => {
                        addProduct({
                          id: validateId(productos, productos.length + 1),
                          name: '',
                          model: '',
                          type: '',
                          uniqueId,
          ...
          >
            ...
            {channels?.length !== 0 && (
              <>
                ...
                >
                  ¿Son las ventas de productos a un mismo cliente?
                </span>
              </>
            )}
          </div>
                      ...
                      <Select
                        ...
                        value={optionsClients.filter(
                          (option) =>
                            option.value ===
                            channels[
                              channels.findIndex((c) => c.name === channel.name)
                            ].sameClient,
                        )}
                        onChange={(e) =>
                          handleEditChannel(
                    ...
                    {productos && productos?.length > 0
                      ? productos.map((prod, index) => (
                          ...
                          >
                            ...
                            >
                              <Input disabled value={prod.name} type="text" />
                            </FormItem>
                            <FormItem
                              className={`mb-0 ${
                                media === 'mobile'
                            ...
                            >
                              <Input
                                ...
                                type="number"
                                min="1"
                                onKeyPress={handleKeyPressVolumen}
                              />
                            </FormItem>
                          </div>
                        ))
                          ...
                          >
                            ...
                            >
                              <Input
                                ...
                                min="1"
                                max="100"
                                onKeyPress={handleKeyPressChurn}
                              />
                            </FormItem>
                          </div>
                        ))
