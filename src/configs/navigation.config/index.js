...
const navigationConfig = [
    ...
    //             path: '/inversionesyamortizaciones',
    //             title: 'Inversiones y Amortizaciones',
    ...
    //         },
    //         {
    //             key: 'collapseMenu.item10',
    //             path: '/estadosfinancieros',
    //             title: 'Estados Financieros',
    //             translateKey: 'nav.collapseMenu.item10',
    //             icon: '',
    //             type: NAV_ITEM_TYPE_ITEM,
    //             authority: [],
    //             subMenu: [],
    //         },
    //         {
    //             key: 'collapseMenu.item11',
    //             path: '/usodefondos',
    //             title: 'Uso de Fondos',
    //             translateKey: 'nav.collapseMenu.item11',
    //             icon: '',
    //             type: NAV_ITEM_TYPE_ITEM,
    //             authority: [],
    //             subMenu: [],
